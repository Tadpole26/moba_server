...
bool BaseInfoDBPkg::ReadDBBaseInfo(sDBSecRet& vecMap, CDBUser* pUser)
{
...
void BaseInfoDBPkg::OnUpdateBaseInfo(unsigned char* pMsg, size uiLen)
{
    assert(pMsg);
...
bool BaseInfoDBPkg::UpdateBaseInfo(Msg_DBGS_UpdateBaseInfo& oUpdate)
{
...
bool BaseInfoDBPkg::AddOrUpdateDBBaseInfo(const Msg_DBGS_UpdateBaseInfo& oUpdate)
{
...
void BaseInfoDBPkg::GetBaseInfo(DBGS_UserData& oData)
{
